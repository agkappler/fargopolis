...
- [x] 5.3 Manual smoke test against a deployed API + running app + Clerk sign-in — deferred to the user. Paste `44.63, -110.72`, confirm list/open/edit/delete, the Google Maps link, region suggestions reuse, and that signed-out users can read but not mutate.
