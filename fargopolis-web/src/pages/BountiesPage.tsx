...
export function BountiesPage() {
    ...
    const onClose = () => { setIsOpen(false); setSelectedBounty(undefined); };
    ...
    const { data: bountyCategories, error: bountyCategoriesError, isLoading: isLoadingBountyCategories, mutate: mutateCategories } =
    ...
    const bountyCategoryMap = (bountyCategories ?? []).reduce(
        (map, cat) => { map[cat.categoryId] = cat; return map; },
    ...
    return (
        <>
            ...
            <LoadingWrapper isLoading={isLoadingBounties || isLoadingBountyCategories}>
                <Grid
                    ...
                    {bounties?.map((bounty) => {
                        ...
                        return (
                            <Box
                                ...
                                onClick={() => { setSelectedBounty(bounty); setIsOpen(true); }}
                            >
                                <StatusChip
